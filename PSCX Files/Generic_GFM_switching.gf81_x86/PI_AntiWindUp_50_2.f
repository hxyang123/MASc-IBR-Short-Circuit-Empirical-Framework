...
!=======================================================================
      ...
      SUBROUTINE PI_AntiWindUp_50_2Dyn(In, Out, frz, Rst, Kp, Ti, Kaw,  &
     &   MaxOut, MinOut)
...
!---------------------------------------
      ...
      IF ( TIMEZERO ) THEN
         FILENAME = 'PI_AntiWindUp_50_2.dta'
         CALL EMTDC_OPENFILE
         SECTION = 'DATADSD:'
...
! 80:[deadband_34_2] Deadband with offset and gain 
      RT_6 = 0.0
...
!  Hard_Limit
      ...
      ELSE
        ...
        IF (STORL(NSTORL) .EQV. .FALSE.) THEN
          CALL EMTDC_WARN(ICALL_NO,8947119,1,"Lower limit is more than t&
     &he upper limit, limits not enforced.")
          STORL(NSTORL) = .TRUE.
        ENDIF
      ENDIF
      NSTORL = NSTORL + 1
...
!=======================================================================
      ...
      SUBROUTINE PI_AntiWindUp_50_2Out()
...
!=======================================================================
      ...
      SUBROUTINE PI_AntiWindUp_50_2Dyn_Begin()
...
!=======================================================================
      ...
      SUBROUTINE PI_AntiWindUp_50_2Out_Begin()
