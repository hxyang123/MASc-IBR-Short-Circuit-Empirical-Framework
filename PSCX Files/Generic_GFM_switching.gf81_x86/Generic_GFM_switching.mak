...
#------------------------------------------------------------------------------
# Project 'Generic_GFM_switching' make using the 'GFortran 8.1' compiler.
#------------------------------------------------------------------------------
...
Arch        = windows
EmtdcDir    = C:\Program Files (x86)\PSCAD501 x64\emtdc\gf81_x86
...
FC_Objects = \
 DS.$(FC_Suffix) \
 Main.$(FC_Suffix) \
 PVFarm_GFL_GFM_2.$(FC_Suffix) \
 SimpleSF_15_2.$(FC_Suffix) \
 Control_12_2_1_1_1.$(FC_Suffix) \
 EPRI_PLL_22_2_1_1_1.$(FC_Suffix) \
 PI_AntiWindUp_50_2.$(FC_Suffix) \
 Sys_2_1.$(FC_Suffix) \
 EPRI_PLL_18_1.$(FC_Suffix) \
...
Binary   = Generic_GFM_switching.exe
