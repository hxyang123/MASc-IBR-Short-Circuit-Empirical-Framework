...
!=======================================================================
      ...
      SUBROUTINE PVFarm_GFL_GFM_2_1Dyn()
...
! 40:[const] Real Constant 'Number of units'
      UN = 400.0
...
! 210:[SimpleSF_15_2_1]  
      CALL SimpleSF_15_2_1Dyn(RT_1, RT_2, NINT(RT_3), RT_4, NINT(UN), Fb&
     &ase, Rated_MW, Vbase, 0.65, 1.4, 0.2, 1, 1.0, 0.0, 1.0, -0.5, 5.0,&
     & 30.0, 1, 0, 20.0, 200.0, 0.5, 20.0, 30.0, 1.0, 0.0, 0.5, 20.0, 0.&
     &1, 0.25, 0.5, 100.0, 3.0, 10.0, 22.22, 0.0, 0.01, 0.5, 20.0, 0.5, &
     &20.0, 1.2, 0.8, 1.3, 0.2, 1.0, 20.0, 0.3, 0.01)
...
!=======================================================================
      ...
      SUBROUTINE PVFarm_GFL_GFM_2_1Dyn_Begin()
...
! 210:[SimpleSF_15_2_1]  
      CALL SimpleSF_15_2_1Dyn_Begin(NINT(UN), Fbase, Rated_MW, Vbase, 0.&
     &65, 1.4, 0.2, 1, 0, 0.1, 0.25, 0.2)
...
! 1:[newpi] Coupled Pi Section Transmission Line 'Line1'
      CALL COMPONENT_ID(ICALL_NO,948106015)
...
!=======================================================================
      ...
      SUBROUTINE PVFarm_GFL_GFM_2_1Out_Begin()
...
! 210:[SimpleSF_15_2_1]  
      CALL SimpleSF_15_2_1Out_Begin(NINT(UN), Fbase, Rated_MW, Vbase, 0.&
     &65, 1.4, 0.2, 1, 0, 0.1, 0.25, 0.2)
