...
!=======================================================================
      ...
      SUBROUTINE EPRI_PLL_22_2_1_1_1Dyn(freq, theta, Vabc, VRT,         &
...
!---------------------------------------
      ...
      IF ( TIMEZERO ) THEN
         FILENAME = 'EPRI_PLL_22_2_1_1_1.dta'
         CALL EMTDC_OPENFILE
         SECTION = 'DATADSD:'
...
!  BUTTERWORTH FILTER
!
      CALL COMPONENT_ID(ICALL_NO,1171101158)
...
! 1460:[hardlimit_66_2_1_1_1] Hard Limiter 
!  Hard_Limit
      ...
      ELSE
        ...
        IF (STORL(NSTORL) .EQV. .FALSE.) THEN
          CALL EMTDC_WARN(ICALL_NO,1777995369,1,"Lower limit is more tha&
...
!=======================================================================
      ...
      SUBROUTINE EPRI_PLL_22_2_1_1_1Out()
...
!=======================================================================
      ...
      SUBROUTINE EPRI_PLL_22_2_1_1_1Dyn_Begin(Tfrz)
...
!=======================================================================
      ...
      SUBROUTINE EPRI_PLL_22_2_1_1_1Out_Begin(Tfrz)
