...
! 210:[SimpleSF_15_2_1]  
     ...
     & 30.0, 1, 0, 20.0, 200.0, 0.5, 20.0, 30.0, 0.0, 1.0, 0.5, 20.0, 0.&
...
! 110:[multimeter] Multimeter 
      ...
      Vgrid_POC(1) = EMTDC_VVDC(SS, NT_1(1), 0)
      Vgrid_POC(2) = EMTDC_VVDC(SS, NT_1(2), 0)
      Vgrid_POC(3) = EMTDC_VVDC(SS, NT_1(3), 0)
